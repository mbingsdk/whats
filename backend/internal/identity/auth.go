...
func (s *Service) Bootstrap(ctx context.Context, in Input) error {
	...
	keys := []string{"organization.view", "members.view", "members.invite", "members.manage", "teams.view", "teams.manage", "roles.view", "roles.manage", "roles.assign", "owners.manage", "audit.view"}
