...
Official policy permits non-template replies within 24 hours of the last user message, with approved templates required outside it. The public pricing overview also describes reset on each user message. These rule facts were read; current developer pricing exceptions remain gated. [Policy](https://business.whatsapp.com/policy), [pricing overview](https://business.whatsapp.com/products/platform-pricing).
