...
- Controlled TEST recipient: operator-designated protected file; format validated; market ID confirmed. Runtime TEST_ONLY/campaign exclusion must be established in the eventual acceptance fixture.
- Callback: last verified empty after Sprint 2 rollback; no new callback change performed.
- General Service delivery TTL: 30 days documented. Safe acceptance/pricing coverage remains UNVERIFIED; fail-closed guard active.
- Live bounded-cost TEST text/status evidence: OPEN; maximum, explicit financial approval and live quote/confirmation integration outstanding; no real outbound request made.
- Company billing currency: IDR, operator-reviewed Meta Billing. Runtime VERIFIED state has not been written by this review; no financial authority exists.
