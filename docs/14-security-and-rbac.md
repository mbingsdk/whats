...
Sprint 0 implements only SMTP configuration and an authenticated TLS/NOOP probe, with synthetic local certificate/authentication tests. No invitation/reset/security mail is sent. Full identity mail behavior above remains Sprint 1 work. The controlled-mailbox procedure and remaining provider information are recorded in [Sprint 0 evidence](23-sprint-0-evidence.md).
