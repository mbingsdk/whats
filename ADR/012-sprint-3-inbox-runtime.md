...
Registry consumes only reviewed Gate C artifacts with original hashes. UNKNOWN billing currency blocks active account rate publication and paid sends. The owner-reviewed zero policy is independent, with hard review/cutoff dates. The September 16 M73 update establishes ordinary Service TTL of 30 days from the general send guide. Eligibility requires executable pricing coverage across that entire interval. The fixed TTL and shared interval predicate enforce coverage; shorter bounds are synthetic fixtures. The owner permits one bounded-cost TEST scenario after review and explicit maximum approval; live financial confirmation/dispatch integration remains closed pending complete executable evidence. Operator settings cannot override missing pricing proof.
